        ...
        return(
            <React.Fragment>
                ...
                <div className="row top">
                  <div className="col-2">
                    <h1>Shopping Cart</h1>
                    {finalArray.length === 0 ? (<MessageBox variant="danger">Cart is Empty. <NavLink to="/" exact={true} strict>Start Shopping</NavLink> </MessageBox>) : (
                    <div>
                        <ul>
                            {finalArray.map((item:any,index:any)=>(
                                <li key={index}>
                                    <div className="row">
                                        <div>
                                        ...
                                        <div >
                                            <NavLink to={`/product/${item._id}`} exact={true} strict>
                  ...
                  <div className="card card-body">
                      <ul>
                          <li>
                              Total Number of Items : {finalArray.reduce((totalItem:any,arg2:any)=> totalItem+arg2.qty,0)} and Grand Total  :  {finalArray.reduce((totalPrice:any,arg2:any)=> totalPrice+(arg2.qty*arg2.price),0)}
                          </li>
                          <li>
...
const send = (dispatch:any)=>{
    return{
        ...
        removeItemFromCart :  (id:any)=>{ dispatch(removeItem(id)) } 
    }
};
